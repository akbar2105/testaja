...
return new class extends Migration
{
    ...
    {
        Schema::create('rekap_harian_tanam', function (Blueprint $table) {
            $table->id();
            ...
            // Field tambahan
            $table->decimal('total_tanam', 10, 2)->default(0)->comment('LTT Reguler - Total harian tgl 1-31');
            ...
            $table->decimal('total_ltt', 10, 2)->default(0)->nullable()->comment('Total LTT = total_tanam + oplah + gogo + csr');
    ...
    {
        Schema::dropIfExists('rekap_harian_tanam');
    }
};