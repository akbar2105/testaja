...
return new class extends Migration
{
    ...
    {
        Schema::create('rekap_tahunan_tanam', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('kabupaten_id');
            $table->integer('tahun');           // Tahun periode (misal: 2024 = Okt 2023 - Sept 2024)
            $table->decimal('total', 15, 3)->default(0); // Total LTT Okt-Sept (Ha)
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('rekap_tahunan_tanam');
    }
};