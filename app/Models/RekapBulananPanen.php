...
class RekapBulananPanen extends Model
{
    use HasFactory;

    protected $table = 'rekap_bulanan_panen';
    ...
    protected static function boot()
    {
        ...
        // ── Setelah disimpan → sync ke RekapTahunanPanen ─────────────────────
        static::saved(function ($m) {
            RekapTahunanPanen::updateOrCreate(
                [
        ...
        // ── Setelah dihapus → hapus RekapTahunanPanen juga ───────────────────
        static::deleted(function ($m) {
            RekapTahunanPanen::where('kabupaten_id', $m->kabupaten_id)
                ->where('tahun', $m->tahun)
                ->delete();
        });
    }
