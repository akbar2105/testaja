...
class RekapHarianPanen extends Model
{
    use HasFactory;

    protected $table = 'rekap_harian_panen';
    ...
    /**
     * Model Events - Auto Update Rekap Bulanan
     */
    protected static function booted()
    {
        // Setelah data harian dibuat, update rekap bulanan
        static::created(function ($rekapHarian) {
            $rekapHarian->updateRekapBulanan();
        });

        // Setelah data harian diupdate, update rekap bulanan
        ...
        // Setelah data harian dihapus, update rekap bulanan
    ...
    /**
     * Update Rekap Bulanan berdasarkan data harian
     */
    ...
    public static function updateRekapBulananFor($kabupatenId, $tahun)
    {
        ...
        $rekapBulanan = RekapBulananPanen::firstOrCreate(
            [
        ...
        $monthlyTotals = static::where('kabupaten_id', $kabupatenId)
            ...
            ->selectRaw('MONTH(tanggal) as bulan, SUM(total_ltp) as total_luas')  // ✅ CHANGED to total_ltt
            ->groupBy('bulan')
