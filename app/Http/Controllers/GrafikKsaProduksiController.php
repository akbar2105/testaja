...
class GrafikKsaProduksiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('grafik.ksa.produksi', compact('tab', 'kabupatens', 'tahunTersedia', 'chartColors', 'chartColorsCount', 'bulanLabels',
    ...
    public function exportPdf(Request $request)
    {
        ...
        $sectionBg    = '#DBEAFE';
        $sectionColor = '#1E3A8A';
        $useDecimals  = true;   // produksi bisa desimal (Ton-GKG)
