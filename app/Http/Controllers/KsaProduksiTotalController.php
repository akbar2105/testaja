...
/**
 * SANDING TOTAL TAHUNAN — READ ONLY
 * Pivot: baris = kabupaten, kolom = tahun
 * Nilai = SUM(produksi) Jan–Des per kabupaten per tahun
 * Filter: tahun_awal, tahun_akhir, kabupaten_id (semua server-side)
 */
class KsaProduksiTotalController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Grand total per kabupaten (sum semua tahun)
        ...
        return view('ksa.produksi.total.index', compact(
