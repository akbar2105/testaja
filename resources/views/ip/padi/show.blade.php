    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex gap-2">
                ...
                {{-- Back Button --}}
                <a href="{{ route('ip.padi.index', ['tahun[]' => $ip->tahun]) }}"
        ...
        <div class="bg-white rounded-xl shadow-xl border border-red-200 overflow-hidden">
            ...
            <div class="p-6">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-lg font-bold text-gray-900 mb-2">Hapus Data Indeks Pertanaman</h3>
                        <p class="text-sm text-gray-600 mb-4">
                            Setelah data dihapus, data tidak dapat dikembalikan. Pastikan Anda yakin sebelum menghapus data ini.
                        </p>
                        <form action="{{ route('ip.padi.destroy', $ip->id) }}" method="POST" class="inline-block">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                                    onclick="return confirm('⚠️ PERINGATAN!\n\nYakin ingin menghapus data IP untuk:\n• Kabupaten: {{ $ip->kabupaten->nama_kabupaten }}\n• Tahun: {{ $ip->tahun }}\n• IP: {{ number_format($ip->ip, 2) }}\n\nData yang sudah dihapus TIDAK DAPAT dikembalikan!')"
