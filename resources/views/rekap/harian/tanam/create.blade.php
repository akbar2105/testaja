...
<div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center justify-between mb-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 flex items-center gap-3">
                    ...
                    Tambah Data Harian Luas Tanam
                </h1>
                <p class="mt-2 text-sm text-gray-600">Input data luas tanam harian per kecamatan</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-xl border border-gray-200">
        <div class="bg-gradient-to-r from-green-500 to-green-600 px-6 py-4 rounded-t-xl">
            <h2 class="text-xl font-bold text-white">Form Tambah Data Harian Luas Tanam</h2>
        </div>

        <form action="{{ route('rekap.harian.tanam.store') }}" method="POST" id="formRekapHarian" class="p-6">
            @csrf
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between mb-4 pb-2 border-b-2 border-green-500">
                    ...
                    <div class="text-sm">
                        ...
                        <span class="ml-2 px-3 py-1 bg-green-100 text-green-800 rounded-lg font-bold" id="totalTanamDisplay">0</span>
            ...
            <div class="mb-6">
                ...
                <div class="mt-4 bg-green-50 border-l-4 border-green-400 p-3 rounded-r-lg">
                    <p class="text-xs text-green-700 font-medium"><strong>Rumus:</strong> Total LTT = Total Tanam + OPLAH + Gogo + CSR | Realisasi = Target - Total LTT</p>
                </div>
            </div>
