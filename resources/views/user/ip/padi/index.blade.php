    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('user.ip.padi.export', array_merge(['tahun_awal' => $tahunAwal, 'tahun_akhir' => $tahunAkhir], request()->only(['kabupaten_id']))) }}"
                            ...
                            <div class="flex items-center justify-center gap-1 flex-nowrap overflow-x-auto">
                                @foreach($selectedYears as $year)
                                    ...
                                    <div class="flex gap-1 border border-green-200 bg-green-50 rounded p-1 items-center">
                                        ...
                                        <a href="{{ route('user.ip.padi.show', $record->id) }}"
