...
<div class="max-w-full mx-auto px-4 py-6">
    ...
    <div class="mb-6 flex items-center justify-between flex-wrap gap-4">
        ...
        <div class="flex gap-2 flex-wrap">
            <a href="{{ route('user.ksa.tanam.export', ['bulan' => $bulan, 'tahun_awal' => $tahunAwal, 'tahun_akhir' => $tahunAkhir]) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex gap-2 h-10">
                        ...
                        <a href="{{ route('user.ksa.tanam.index') }}" class="h-10 px-4 flex items-center justify-center bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 font-semibold text-sm transition-all whitespace-nowrap">
                            Reset
                        </a>
                        @endif
                    </div>
    ...
    <div class="bg-gradient-to-r from-orange-50 to-amber-50 border-l-4 border-orange-500 p-4 mb-6 rounded-r-lg shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <p class="text-sm text-orange-800">
                <strong>Sanding Tahunan per Bulan</strong> &mdash; Data otomatis dari
                <a href="{{ route('user.ksa.tanam.bulanan.index') }}" class="underline font-bold">Sanding Bulanan</a>.
                Bulan: <strong>{{ $namaBulan }}</strong> &bull; Periode: {{ $tahunAwal }}&ndash;{{ $tahunAkhir }} &bull; Satuan: <strong>Ha</strong>
            </p>
        </div>
    </div>
