...
<div class="max-w-full mx-auto px-4 py-6">
    ...
    <div class="mb-6 flex items-center justify-between flex-wrap gap-4">
        ...
        <div class="flex gap-2 flex-wrap">
            <a href="{{ route('user.ksa.produksi.bulanan.export', ['tahun' => $tahun]) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex gap-2 h-10">
                        ...
                        <a href="{{ route('user.ksa.produksi.bulanan.index') }}" class="h-10 px-4 flex items-center justify-center bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 font-semibold text-sm transition-all whitespace-nowrap">
                            Reset
                        </a>
                    </div>
                </div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg shadow-md">
        <div class="flex items-center gap-3">
            ...
            <p class="text-sm text-blue-800 font-medium">
                ...
                <a href="{{ route('user.ksa.produksi.index') }}" class="underline font-bold">Sanding Tahunan per Bulan</a> dan
                <a href="{{ route('user.ksa.produksi.total.index') }}" class="underline font-bold">Sanding Total Tahunan</a>.
            ...
            <table class="min-w-full text-xs border-collapse">
                <thead>
                    <tr class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
                        ...
                        <th class="border border-blue-700 px-4 py-2 text-center font-bold" colspan="12">Produksi Padi (Ton GKG) Tahun {{ $tahun }}</th>
                ...
                <tbody class="bg-white">
                    ...
                    @empty
                    <tr><td colspan="15" class="py-10 text-center text-gray-400 font-semibold">Belum ada data kabupaten</td></tr>
                    @endforelse
                </tbody>
                <tfoot>
