...
<div class="max-w-full mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-2 flex-wrap justify-end">
            <a href="{{ route('user.rekap.tahunan.panen.export', request()->query()) }}"
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('user.rekap.tahunan.panen.index') }}" class="px-4 py-2.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 font-semibold text-sm transition-all">Reset</a>
                </div>
            </div>
        </div>
    </form>
