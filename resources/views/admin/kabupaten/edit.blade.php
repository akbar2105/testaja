...
<div class="max-w-xl mx-auto mt-10 p-6 bg-white rounded-2xl shadow-lg border border-gray-200">
    <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">Edit Kabupaten</h2>

    <form action="{{ route('admin.kabupaten.update', $kabupaten->id) }}" method="POST" class="space-y-5">
        @csrf
        @method('PUT')
