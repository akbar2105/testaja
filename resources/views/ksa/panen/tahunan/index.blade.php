...
<div class="max-w-full mx-auto px-4 py-6">
    ...
    <div class="mb-6 flex items-center justify-between flex-wrap gap-4">
        ...
        <a href="{{ route('ksa.panen.export', ['bulan' => $bulan, 'tahun_awal' => $tahunAwal, 'tahun_akhir' => $tahunAkhir]) }}"
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('ksa.panen.index') }}" class="px-4 py-2.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 font-semibold text-sm transition-all whitespace-nowrap">Reset</a>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="bg-gradient-to-r from-violet-50 to-indigo-50 border-l-4 border-violet-500 p-4 mb-6 rounded-r-lg shadow-md">
        <div class="flex items-center gap-3">
            ...
            <p class="text-sm text-violet-800 font-medium">
                <strong>Sanding Tahunan per Bulan</strong> &mdash; Data otomatis dari <a href="{{ route('ksa.panen.bulanan.index') }}" class="underline font-bold">Sanding Bulanan</a>.
