...
<div class="max-w-full mx-auto px-4 py-6">
    ...
    <div class="mb-6 flex items-center justify-between flex-wrap gap-4">
        ...
        <div class="flex gap-2 flex-wrap">
            <a href="{{ route('ksa.produksi.total.export', ['tahun_awal' => $tahunAwal, 'tahun_akhir' => $tahunAkhir]) }}"
        ...
        <div class="bg-white rounded-xl shadow-md p-6 border border-gray-200">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="{{ route('ksa.produksi.total.index') }}" class="px-4 py-2.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 font-semibold text-sm transition-all whitespace-nowrap">Reset</a>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg shadow-md">
        <div class="flex items-center gap-3">
            ...
            <p class="text-sm text-blue-800 font-medium">
                ...
                <a href="{{ route('ksa.produksi.bulanan.index') }}" class="underline font-bold">Sanding Bulanan per Tahun</a>.
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        <td colspan="{{ count($years) + 3 }}" class="py-12 text-center text-gray-400 font-semibold">
                            ...
                            <a href="{{ route('ksa.produksi.bulanan.index') }}" class="text-blue-600 underline">Sanding Bulanan per Tahun</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
